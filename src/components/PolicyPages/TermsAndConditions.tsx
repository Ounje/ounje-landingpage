  ...
  return (
    <div className="py-4 px-10 w-full lg:w-[80%] text-[#2C5E2E] bg-[#FFF3E8] rounded-[20px] items-center transition easein">
      ...
      <ul>
        ...
        <li>
          “User” / “You” means anyone who accesses or uses our services,
      ...
      <ul>
        ...
        <li>Ensure timely payment for all orders.</li>
        <li>Treat vendors and delivery staff respectfully.</li>
        <li>
          Do not misuse our platform for illegal, fraudulent, or harmful
          activities.
        </li>
        <li>
      ...
      <ul>
        <li>
          Prices are set by vendors and may include taxes and service fees.
        </li>
        <li>
          Payment must be made through the available payment options i.e
          Paystack
        </li>
        <li>
          Once an order is placed and confirmed, it cannot be canceled after
          food preparation has begun.
        </li>
      </ul>
      <h2 className="text-lg font-bold">6. Delivery Policy</h2>
      <ul>
        <li>
          Delivery times are estimates and may vary due to location, traffic, or
          vendor preparation time.
        </li>
        <li>
          You must be available at the delivery address during the estimated
          delivery window.
        </li>
      ...
      <ul>
        <li>Refunds are only applicable in cases of:</li>
        <li>Order not delivered.</li>
        <li>Wrong item delivered.</li>
        <li>Food not fit for consumption subject to investigation.</li>
        <li>
          Refunds will be processed via the original payment method within [1-2
          business days].
        </li>
      </ul>
      <h2 className="text-lg font-bold">8. Vendor Responsibilities</h2>
      <ul>
        <li>Vendors must comply with health and safety regulations.</li>
        <li>
      ...
      <ul>
        ...
        <li>
          We are not liable for delays or failure caused by circumstances beyond
          our control (traffic, strikes, natural disasters, etc.).
        </li>
      </ul>
      ...
      <h2 className="text-lg font-bold">14. Changes to Terms</h2>
      <ul>
        <li>
