    ...
    <>
      <section className="md:h-[40vh] text-center text-[#2C5E2E] p-3 md:p-5">
        <div>
          ...
          <div className="text-[#2C5E2E] mt-5 md:px-20 px-[10px] pt-[20px]">
            <p>
            ...
            <p>
              ...
              food spots, giving them a way to serve you better while keeping
              things simple and local. From Pidgin support to seamless delivery,
              OUNJE is built for everyday Nigerians who want good food without
              the stress. Na food wey go
            </p>
          </div>
        </div>
      </section>
