...
export default function Hero() {
  ...
  return (
    <section
      id="contactHero"
      className="relative overflow-hidden bg-gradient-to-b from-[#ECFFED] to-white pt-28 pb-4 md:pb-16"
    >
      {/* Decorative blobs */}
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 flex flex-col items-center text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -left-12 top-8 bg-white border border-[#2C5E2E]/20 rounded-2xl px-3 py-2 shadow-lg flex items-center gap-2 text-xs font-semibold text-[#1A3F1C]"
          >
            💬 Chat with us
          </motion.div>
          <motion.div
            ...
            className="absolute -right-12 bottom-16 bg-[#FFC727] rounded-2xl px-3 py-2 shadow-lg flex items-center gap-2 text-xs font-semibold text-[#1A3F1C]"
          >
            📧 Quick response
          </motion.div>
        </motion.div>
